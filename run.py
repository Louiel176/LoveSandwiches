...
def validate_data(values):
    """
    Inside the try, converts all string values into intregers.
...
"""
    ""Two functions that use different data but does the same thing so the code
    below the commented out code refactors the two functions into one""
...
def update_worksheet(data, worksheet):
    ...
    Update the relevent worksheets with the data provided
    """
